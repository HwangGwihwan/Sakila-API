                ...
                </tr>
                {
                    customerList.map((c) => (
                        <tr key={c.customerId}>
                            ...
                            <td className="border border-gray-300 text-center"><Link to={`/CustomerOne/${c.customerId}`}>{c.firstName}</Link></td>
                            <td className="border border-gray-300 text-center"><Link to={`/CustomerOne/${c.customerId}`}>{c.lastName}</Link></td>
                        </tr>
                    ))
